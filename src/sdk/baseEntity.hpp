...
public:
	...
	{
		GetVFunc<void( __thiscall* )( void* )>( this, 224 )( this );
	}


	void SetModelIndex(int index)
	{
		GetVFunc<void(__thiscall*)(CBaseEntity*, int)>(this, 75)(this, index);
	}
	...
	CBasePlayerAnimState* animState( )
	{
		return *reinterpret_cast< CBasePlayerAnimState** >( uintptr_t( this ) + 0x3914 );
	}
	...
	{
		static int m_hGroundEntity = g_NetVarManager->GetOffset("DT_BasePlayer", "m_hGroundEntity");

		return getValue<CBaseHandle>(m_hGroundEntity);
	}
	...
	int MdlIndex() {
		static int m_bMdlIndex = g_NetVarManager->GetOffset("DT_BaseEntity", "m_nModelIndex");
		return getValue<int>(m_bMdlIndex);
	}
	...
	{
		return ( ICollideable* ) ( ( unsigned long ) this + 0x320 );
	}
	...
	void UpdateAnimationState(CBasePlayerAnimState* state, Vector3 angle);
...
public:
	...
	float inaccuracy()
	{
		...
		return ((OriginalFn)g_InterfaceUtils->getVfuncTable(this)[482])(this);
	}

	float spread()
	{
		using OriginalFn = VFUNC_SIGNATURE(float);
		return ((OriginalFn)g_InterfaceUtils->getVfuncTable(this)[452])(this);
	}
	...
	{
		using OriginalFn = VFUNC_SIGNATURE(float);
		return ((OriginalFn)g_InterfaceUtils->getVfuncTable(this)[483])(this);
	}
	...
	CSWeaponInfo* weaponData()
	{
		...
		return ((OriginalFn)g_InterfaceUtils->getVfuncTable(this)[460])(this);
	}
	...
	{
		static int m_flNextSecondaryAttack = g_NetVarManager->GetOffset("DT_BaseCombatWeapon", "LocalActiveWeaponData", "m_flNextSecondaryAttack");
